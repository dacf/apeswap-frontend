      ...
      <Menu>
        <Suspense fallback={<PageLoader />}>
          <Switch>
            ...
            {/* SWAP ROUTES */}
            <Route path="/swap" component={NewSwap} />
